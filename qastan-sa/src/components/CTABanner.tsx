...
function CtaBanner() {
  return (
    <div className="relative bg-gray-800 py-12 px-6 md:py-24 md:px-12 text-center text-white">
      ...
      <h1 className="text-xl lg:text-4xl md:text-6xl font-semibold mb-4">Samen duiken in de digitalisering van jouw onderneming?</h1>
      <p className="text-lg md:text-xl mb-8">We helpen je graag verder na een verkennend gesprek. We luisteren naar jouw noden, stellen een gepaste oplossing voor en laten je bedrijf vliegen!</p>
