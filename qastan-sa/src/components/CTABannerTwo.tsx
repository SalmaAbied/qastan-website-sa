...
function CtaBanner() {
  return (
    <div className="mx-auto relative  md:m-20 bg-gray-800 py-12 px-6 md:py-24 md:px-12 text-center text-white my-20">
      ...
      <div className="flex flex-col justify-end items-center p-6">
        <a href="#" className="block w-fit md:mt-0 mt-2 font-medium md:mr-0 mr-2 bg-orange-500 px-5 py-3 border-2 border-orange-500 hover:bg-gray-800 hover:text-orange-500 hover:border-2 hover:border-orange-500 transition duration-300">
