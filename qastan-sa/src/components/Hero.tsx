  ...
  return (
    <section className="grid grid-cols-1 lg:grid-cols-2 place-items-center sm:p-5 md:p-10 overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row items-center lg:justify-end">
        <img className="px-5 lg:hidden" src={puffin} alt="puffin" />
        <img className="hidden lg:block max-w-full w-36 xl:w-48 mr-2 mb-5 lg:mb-0 " src={left} alt="left side puffin" />
        <img className="hidden lg:block max-w-full w-36 xl:w-48 -translate-y-6 mb-5 lg:mb-0" src={middle} alt="middle side puffin" />
        <img className="hidden lg:block max-w-full w-36 xl:w-48 ml-2 mb-5 lg:mb-0" src={right} alt="right side puffin" />
      </div>
    </section>
  );
};
