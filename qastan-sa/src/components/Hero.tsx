  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 place-items-center p-10 min-h-screen overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row items-center md:justify-end">
        <img className="md:hidden" src={puffin} alt="puffin" />
        <img className="hidden md:block max-w-full w-56 mr-2 mb-5 md:mb-0 " src={left} alt="left side puffin" />
        <img className="hidden md:block max-w-full w-56 -translate-y-6 mb-5 md:mb-0" src={middle} alt="middle side puffin" />
        <img className="hidden md:block max-w-full w-56 ml-2 mb-5 md:mb-0" src={right} alt="right side puffin" />
      </div>
    </section>
  );
}
