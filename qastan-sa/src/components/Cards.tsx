  ...
  return (
    <section className="container mx-auto">
      ...
      <div className="gap-6 flex flex-wrap justify-center">
        <div className="relative bg-gray-800 overflow-hidden shadow-lg w-96 rounded-lg rounded-t-md border-t-4 border-orange-500 shadow-2xl">
        ...
        <div className="relative bg-gray-800 overflow-hidden shadow-lg w-96 rounded-lg rounded-t-md border-t-4 border-pink-500 shadow-2xl">
          <div className="relative w-full h-96">
            <img
        ...
        <div className="relative bg-gray-800 overflow-hidden shadow-lg w-96 rounded-lg rounded-t-md border-t-4 border-blue-500 shadow-2xl">
          <div className="relative w-full h-96">
            <img
