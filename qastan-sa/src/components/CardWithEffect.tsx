...
const Card = ({ title, imageUrl, description, color }: { title: string; imageUrl: string; description: string; color: string }) => {
  return (
...
export default CardWithTitleAndText;
