        ...
        <div key={index} className={`bg-[#fcac0027] mb-8 md:mb-20 flex flex-col xl:flex-row md:items-center ${index % 2 === 0 ? "" : "md:flex-row-reverse bg-blue-500"}`}>
          <div className="w-full xl:w-1/2 mx-auto px-10 py-5">
            ...
            <div className="flex justify-start my-10 text-white">
              <a href="#" className="block w-fit md:mt-0 mt-2 font-medium md:mr-5 mr-2 bg-orange-500 px-5 py-3 hover:bg-transparent border-2 border-orange-500 hover:text-orange-500">
                Ontmoet het team
              </a>
              <a href="#" className="block w-fit md:mt-0 mt-2 text-orange-500 font-medium md:mr-0 mr-2 border-2 border-orange-500 px-5 py-3 hover:bg-orange-500 hover:text-white">
