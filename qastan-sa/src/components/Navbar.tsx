      ...
      {mobileMenuOpen && (
        <div className="lg:hidden flex items-center justify-center">
          <div className="h-screen w-screen py-4 px-2 flex flex-col items-center">
            <a href="/" className="block py-2 px-4 font-medium">
              Home
            </a>
            <a href="/" className="m-2 flex items-center">
              <NavigationMenuDemo />
            </a>
            <a href="/Toepassingen" className="block py-2 px-4 font-medium">
              Toepassingen
            </a>
            <a href="/Over" className="block py-2 px-4 font-medium">
              Over ons
            </a>
            <a href="/Contact" className="block py-2 px-4 font-medium">
              Contact
            </a>
            <a href="/Blog" className="block py-2 px-4 font-medium">
              Blog
            </a>
